data1 = [kbeta_comp_places(3,1:23), kbeta_comp_faces(3,1:22)];
data1(all(~data1, 1)) = [];
data1 = data1';

data2 = [kbeta_comp_places(3,24:end), kbeta_comp_faces(3,23:end)];
data2(:,all(~data2, 1)) = [];
data2 = data2';
...
RGB_temp = [];
RGB_temp(:,1) = repelem(RGB_color(1,:),43);
RGB_temp = reshape(RGB_temp,43,[]);

RGB_temp2 = [];
RGB_temp2(:,1) = repelem(RGB_color(2,:),43);
RGB_temp2 = reshape(RGB_temp2,43,[]); 
